  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-6 left-6 z-50 w-16 h-16 rounded-full btn-golden flex items-center justify-center transition-all duration-300 active:scale-95 ${isOpen ? "rotate-45 bg-muted" : ""
          }`}
        style={{
